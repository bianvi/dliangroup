          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                className={`testimonial-glass p-10 flex flex-col justify-between group hover:border-${card.color}/50 transition-all duration-500 rounded-2xl`}
              >
                <div>
                  <div className={`w-12 h-12 mb-8 flex items-center justify-center bg-${card.color}/10 border border-${card.color}/30 text-${card.color} rounded-lg`}>
                    {card.num}
                  </div>
