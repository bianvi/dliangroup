      ...
      <div className="max-w-7xl mx-auto px-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center gap-3">
            ...
            <span className="text-lg font-bold tracking-[0.2em] uppercase text-white">D'Lian Group</span>
          </div>
          ...
          <p className="text-white/40 text-sm font-medium">© 2024 D'Lian Group. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
